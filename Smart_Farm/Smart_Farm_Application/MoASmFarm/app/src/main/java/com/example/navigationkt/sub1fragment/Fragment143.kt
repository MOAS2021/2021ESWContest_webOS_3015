...
import kotlinx.android.synthetic.main.fragment_143.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class Fragment143 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_143, container, false)
    }
