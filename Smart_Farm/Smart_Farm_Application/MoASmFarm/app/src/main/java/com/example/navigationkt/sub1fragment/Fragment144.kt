...
import kotlinx.android.synthetic.main.fragment_144.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class Fragment144 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_144, container, false)
    }
