...
import kotlinx.android.synthetic.main.fragment_guidefragment1.*
...
class guidefragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_guidefragment1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        jump1.setOnClickListener {
            navController1.navigate(R.id.action_guidefragment1_to_guidefragment2)
        }
    }
