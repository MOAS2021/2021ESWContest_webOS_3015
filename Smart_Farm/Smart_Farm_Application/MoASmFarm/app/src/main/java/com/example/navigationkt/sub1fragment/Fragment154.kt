...
import kotlinx.android.synthetic.main.fragment_154.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class Fragment154 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_154, container, false)
    }
