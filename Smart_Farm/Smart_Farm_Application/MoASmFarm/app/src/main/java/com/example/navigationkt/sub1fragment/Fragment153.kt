...
import kotlinx.android.synthetic.main.fragment_153.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class Fragment153 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_153, container, false)
    }
