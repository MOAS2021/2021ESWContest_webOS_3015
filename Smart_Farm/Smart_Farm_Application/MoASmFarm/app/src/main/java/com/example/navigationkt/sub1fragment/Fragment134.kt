...
import kotlinx.android.synthetic.main.fragment_134.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class Fragment134 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_134, container, false)
    }
