...
import kotlinx.android.synthetic.main.fragment_133.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class Fragment133 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_133, container, false)
    }
